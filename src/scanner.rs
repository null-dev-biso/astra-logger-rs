...
//cli
//нейронка для обработки
//Реализация функции экспорта собранной статистики и результатов анализа в
//файл (например, в формате CSV или JSON) для последующего использования
//или внешнего анализа
//Добавление опций для настройки формата вывода результатов, например,
//выбор между сводной статистикой и полным списком сообщений;
//Провести тестирование: юнит-тестирование, интеграционное тестирование,
//системное тестирование, автоматизация тестирования.
